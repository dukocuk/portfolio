...
export function Contact() {
  ...
  return (
    <Section id="contact" index="08" eyebrow="Contact" title="Let's build reliable software solutions.">
      <div className="grid grid-cols-1 gap-4 md:grid-cols-5">
        ...
        <Card className="flex h-full flex-col md:col-span-3">
          ...
          <div className="mt-1 flex flex-wrap items-center gap-3">
            <a href={`mailto:${profile.email}`} className="text-lg font-semibold text-accent hover:opacity-80">
              {profile.email}
            </a>
            <button
              type="button"
        ...
        <div className="flex h-full flex-col justify-between rounded-2xl bg-accent-gradient p-6 text-white shadow-lg shadow-accent/25 md:col-span-2">
          <p className="text-xs font-semibold uppercase tracking-wider text-white/80">Availability</p>
